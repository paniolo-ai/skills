...
| -------------------- | --------------- | --------------------------- |
| 1. Get report        | None            | Automatic                   |
| 2. Goodwill framing  | None            | Automatic                   |
| 3. Fix plan + select | AskUserQuestion | **High + Medium**           |
| 4. Re-scan + delta   | None            | Automatic                   |

A typical run is one decision (which findings to fix).
